...
export const HeroSection: React.FC = () => {
  return (
    ...
    >
      ...
      <button className="bg-black text-white px-6 sm:px-8 py-3.5 rounded-full font-bold hover:bg-gray-900 hover:scale-105 active:scale-95 transition-all text-sm whitespace-nowrap shadow-lg flex-shrink-0">
        Try online for free
      </button>
    </motion.div>
    </>
