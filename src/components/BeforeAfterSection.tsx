...
export const BeforeAfterSection: React.FC = () => {
  return (
    <section className="py-24 px-4 bg-[#0a0a0a] border-y border-white/5 relative overflow-hidden flex flex-col items-center text-center">
      <div className="max-w-4xl mx-auto z-10 w-full flex flex-col items-center">
        <h2 className="text-3xl md:text-5xl font-black mb-6 text-white">One Tap. <span className="text-[#00F2DC]">Zero Effort.</span></h2>
        ...
        <div className="relative w-full max-w-sm sm:max-w-md md:max-w-xl mx-auto aspect-[4/5] sm:aspect-video rounded-3xl overflow-hidden shadow-2xl border border-white/10 group bg-gray-900 flex justify-center items-center">
