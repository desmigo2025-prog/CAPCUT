...
export const ProblemSolutionSection: React.FC = () => {
  return (
    <section className="py-24 px-4 bg-white relative border-y border-gray-100">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-gray-900">Stop wrestling with complicated software.</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
          ...
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#00F2DC]/20 blur-3xl rounded-full mix-blend-multiply"></div>
            <div className="flex items-center gap-3 mb-6 text-[#00F2DC] relative z-10">
              <CheckCircle2 className="w-8 h-8 text-[#00F2DC]" />
              <h3 className="text-2xl font-bold text-gray-900">The CapCut Way</h3>
            </div>
